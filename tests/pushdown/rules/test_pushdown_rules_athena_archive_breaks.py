...
from payloads.pushdown.rules.pl_pd_athena_rules_sales_archive_breaks import (
    PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_CONNECTION,
...
@pytest.mark.athena
class TestPushdownRulesAthenaArchiveBreaks:
    ...
    def test_pushdown_athena_rules_sales_archive_breaks(self, api_utils):
        helper.run_pushdown_job_if_dataset_does_not_exist(
            api_utils, PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD
        )
        ...
        athena_format_run_id_date_time = helper.run_id_to_date_time(job_response["runId"])
        ...
        validate_pushdown_rules_archived_break_records(
            ...
            PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_CONNECTION,
            PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_DATASET,
            athena_format_run_id_date_time,
            PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_EXPECTED_DATA,
            PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_EXPECTED_QUERY_RESULT,
        )
        validate_downloaded_rule_breaks(
        ...
        validate_downloaded_job_rule_breaks(
            api_utils,
            PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_DATASET,
            PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD["runId"],
            "CSV",
            PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_EXPECTED_CSV_OUTPUT,
        )
        validate_downloaded_job_rule_breaks(

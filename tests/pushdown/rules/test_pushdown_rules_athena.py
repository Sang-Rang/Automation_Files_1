...
from data_test.pushdown.rules.data_pd_athena_rules_binary_sales import (
    PD_ATHENA_RULES_BINARY_SALES_EXPECTED_RULE_OUTPUT,
    PD_ATHENA_RULES_BINARY_SALES_RULE_DEFINITIONS,
)
from data_test.pushdown.rules.data_pd_athena_rules_nyse import (
    PD_ATHENA_RULES_NYSE_EXPECTED_RULE_OUTPUT,
    PD_ATHENA_RULES_NYSE_RULE_DEFINITIONS,
)
from data_test.pushdown.rules.data_pd_athena_rules_sales import (
    PD_ATHENA_RULES_SALES_EXPECTED_RULE_OUTPUT,
    PD_ATHENA_RULES_SALES_RULE_DEFINITIONS,
)
from data_test.pushdown.rules.data_pd_athena_rules_sales_archive_breaks import (
    PD_ATHENA_RULES_SALES_ARCHIVE_BREAKS_EXPECTED_RULE_OUTPUT,
)
from data_test.pushdown.rules.data_pd_athena_rules_sales_link_id import (
...
from data_test.pushdown.rules.data_pd_athena_rules_temporal_sales import (
...
from payloads.pushdown.rules.pl_pd_athena_rules_basic import (
    PD_ATHENA_RULES_BASIC_DATASET,
...
from payloads.pushdown.rules.pl_pd_athena_rules_binary_sales import (
    ...
    PD_ATHENA_RULES_BINARY_SALES_PAYLOAD,
)
from payloads.pushdown.rules.pl_pd_athena_rules_nyse import (
    PD_ATHENA_RULES_NYSE_DATASET,
    PD_ATHENA_RULES_NYSE_PAYLOAD,
)
from payloads.pushdown.rules.pl_pd_athena_rules_sales import (
    PD_ATHENA_RULES_SALES_DATASET,
    PD_ATHENA_RULES_SALES_PAYLOAD,
)
from payloads.pushdown.rules.pl_pd_athena_rules_sales_link_id import (
    PD_ATHENA_RULES_SALES_LINK_ID_DATASET,
    PD_ATHENA_RULES_SALES_LINK_ID_PAYLOAD,
)
from payloads.pushdown.rules.pl_pd_athena_rules_temporal_sales import (
    PD_ATHENA_RULES_TEMPORAL_SALES_DATASET,
    PD_ATHENA_RULES_TEMPORAL_SALES_PAYLOAD,
)
...
class TestPushdownRulesAthena:
    ...
    def test_pushdown_athena_rules_basic(self, api_utils):
        ...
        job_response = helper.run_pushdown_job(api_utils, PD_ATHENA_RULES_BASIC_PAYLOAD)
        validate_rules_findings(
            api_utils,
            PD_ATHENA_RULES_BASIC_DATASET,
            job_response["runId"],
    ...
    def test_pushdown_athena_rules_binary_sales(self, api_utils):
        ...
        job_response = helper.run_pushdown_job(api_utils, PD_ATHENA_RULES_BINARY_SALES_PAYLOAD)
        validate_rules_findings(
            api_utils,
            PD_ATHENA_RULES_BINARY_SALES_DATASET,
            job_response["runId"],
    ...
    @allure.feature("Pushdown")
    @allure.story("Pushdown - Rules")
    def test_pushdown_athena_rules_nyse(self, api_utils):
        ...
        job_response = helper.run_pushdown_job(api_utils, PD_ATHENA_RULES_NYSE_PAYLOAD)
        validate_rules_findings(
            api_utils,
            PD_ATHENA_RULES_NYSE_DATASET,
            job_response["runId"],
    ...
    @allure.feature("Pushdown")
    @allure.story("Pushdown - Rules")
    def test_pushdown_athena_rules_sales(self, api_utils):
        helper.run_pushdown_job_if_dataset_does_not_exist(api_utils, PD_ATHENA_RULES_SALES_PAYLOAD)
        helper.set_rules_on_dataset(
            api_utils,
            PD_ATHENA_RULES_SALES_DATASET,
            PD_ATHENA_RULES_SALES_RULE_DEFINITIONS,
        )
        job_response = helper.run_pushdown_job(api_utils, PD_ATHENA_RULES_SALES_PAYLOAD)
        validate_rules_findings(
            api_utils,
            PD_ATHENA_RULES_SALES_DATASET,
            job_response["runId"],
    ...
    @allure.feature("Pushdown")
    @allure.story("Pushdown - Rules")
    def test_pushdown_athena_rules_sales_link_id(self, api_utils):
        helper.run_pushdown_job_if_dataset_does_not_exist(
            api_utils, PD_ATHENA_RULES_SALES_LINK_ID_PAYLOAD
        )
        helper.set_rules_on_dataset(
            api_utils,
            PD_ATHENA_RULES_SALES_LINK_ID_DATASET,
        ...
        job_response = helper.run_pushdown_job(api_utils, PD_ATHENA_RULES_SALES_LINK_ID_PAYLOAD)
        validate_rules_findings(
            api_utils,
            PD_ATHENA_RULES_SALES_LINK_ID_DATASET,
            job_response["runId"],
        ...
        validate_downloaded_job_rule_breaks(
            api_utils,
            PD_ATHENA_RULES_SALES_LINK_ID_DATASET,
            PD_ATHENA_RULES_SALES_LINK_ID_PAYLOAD["runId"],
            "CSV",
            PD_ATHENA_RULES_SALES_LINK_ID_EXPECTED_CSV_OUTPUT,
        )
        validate_downloaded_job_rule_breaks(
    ...
    @allure.feature("Pushdown")
    @allure.story("Pushdown - Rules")
    def test_pushdown_athena_rules_temporal_sales(self, api_utils):
        helper.run_pushdown_job_if_dataset_does_not_exist(
            api_utils, PD_ATHENA_RULES_TEMPORAL_SALES_PAYLOAD
        )
        helper.set_rules_on_dataset(
            api_utils,
            PD_ATHENA_RULES_TEMPORAL_SALES_DATASET,
        ...
        helper.run_pushdown_job(api_utils, PD_ATHENA_RULES_TEMPORAL_SALES_PAYLOAD)

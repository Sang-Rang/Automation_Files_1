...
from data_test.pushdown.rules.data_pd_trino_rules_sales_archive_breaks import (
...
from payloads.pushdown.rules.pl_pd_trino_rules_sales_archive_breaks import (
    PD_TRINO_RULES_SALES_ARCHIVE_BREAKS_CONNECTION,
    PD_TRINO_RULES_SALES_ARCHIVE_BREAKS_DATASET,
    PD_TRINO_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD,
)
...
@pytest.mark.trino
class TestPushdownRulesTrinoArchiveBreaks:
    ...
    def test_pushdown_trino_rules_sales_archive_breaks(self, api_utils):
        helper.run_pushdown_job_if_dataset_does_not_exist(
            api_utils, PD_TRINO_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD
        )
        ...
        validate_downloaded_job_rule_breaks(
            api_utils,
            PD_TRINO_RULES_SALES_ARCHIVE_BREAKS_DATASET,
            PD_TRINO_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD["runId"],
            "CSV",
            PD_TRINO_RULES_SALES_ARCHIVE_BREAKS_EXPECTED_CSV_OUTPUT,
        )
        validate_downloaded_job_rule_breaks(

...
from payloads.pushdown.rules.pl_pd_dbrks_rules_sales_archive_breaks import (
    PD_DBRKS_RULES_SALES_ARCHIVE_BREAKS_CONNECTION,
    PD_DBRKS_RULES_SALES_ARCHIVE_BREAKS_DATASET,
    PD_DBRKS_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD,
)
...
class TestPushdownRulesDatabricksArchiveBreaks:
    ...
    def test_pushdown_databricks_rules_sales_archive_breaks(self, api_utils):
        helper.run_pushdown_job_if_dataset_does_not_exist(
            api_utils, PD_DBRKS_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD
        )
        ...
        validate_downloaded_job_rule_breaks(
            api_utils,
            PD_DBRKS_RULES_SALES_ARCHIVE_BREAKS_DATASET,
            PD_DBRKS_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD["runId"],
            "CSV",
            PD_DBRKS_RULES_SALES_ARCHIVE_BREAKS_EXPECTED_CSV_OUTPUT,
        )
        validate_downloaded_job_rule_breaks(

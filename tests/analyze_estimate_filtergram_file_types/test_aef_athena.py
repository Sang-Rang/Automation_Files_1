...
class TestAnalyzeEstimateFiltergramAthenaUp:
    ...
    def test_analyze_estimate_filtergram_approved_athena_up(self, api_utils):
        """Test analyze, estimate, filtergram approved athena up."""
        ...
        aef.filtergram(api_utils, PL_FILTERGRAM_SINGLE, EXP_FILTERGRAM_SINGLE)
        aef.filtergram(api_utils, PL_FILTERGRAM_MULTIPLE, EXP_FILTERGRAM_MULTIPLE)

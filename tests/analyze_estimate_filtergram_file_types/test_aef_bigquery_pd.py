...
from data_test.analyze_estimate_filtergram_file_types.data_aef_bigquery_pd import (
    AEF_BQ_PD_PAYLOAD,
    WHERE_DATE,
    ROW_COUNT,
    PL_DAYS_WITH_DATA,
...
class TestAnalyzeEstimateFiltergramBigqueryKeyPd:
    ...
    def test_analyze_estimate_filtergram_approved_bigquery_pushdown(self, api_utils):
        dataset_defs = AEF_BQ_PD_PAYLOAD

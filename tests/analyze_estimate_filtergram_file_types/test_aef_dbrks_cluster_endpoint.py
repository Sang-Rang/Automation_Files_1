...
from data_test.analyze_estimate_filtergram_file_types.data_aef_dbrks_cluster_endpoint import (
    WHERE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramDbrksClusterEndpoint:
    ...
    def test_analyze_estimate_filtergram_approved_dbrks_cluster_endpoint(self, api_utils):
        """Test analyze, estimate, filtergram approved databricks cluster endpoint."""

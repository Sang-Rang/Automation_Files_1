...
from data_test.analyze_estimate_filtergram_file_types.data_aef_redshift_pd import (
    AEF_RS_PD_PAYLOAD,
    WHERE_DATE,
    ROW_COUNT,
    PL_DAYS_WITH_DATA,
...
class TestAnalyzeEstimateFiltergramRedshiftPd:
    ...
    def test_analyze_estimate_filtergram_approved_redshift_pd(self, api_utils):
        """Test analyze, estimate, filtergram approved redshift pd"""
        dataset_defs = AEF_RS_PD_PAYLOAD

...
from data_test.analyze_estimate_filtergram_file_types.data_aef_postgres_pwdmgr import (
    WHERE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramPostgresPwdmgr:
    ...
    def test_analyze_estimate_filtergram_approved_postgres_pwdmgr(self, api_utils):
        """Test analyze, estimate, filtergram approved postgres pwdmgr"""

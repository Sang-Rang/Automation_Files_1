...
from data_test.analyze_estimate_filtergram_file_types.data_aef_dbrks_sql_endpoint import (
    WHERE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramDbrksSqlEndpoint:
    ...
    def test_analyze_estimate_filtergram_approved_dbrks_sql_endpoint(self, api_utils):
        """Test analyze, estimate, filtergram approved databricks sql endpoint."""

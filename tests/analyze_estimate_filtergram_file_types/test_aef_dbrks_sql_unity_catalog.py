...
from data_test.analyze_estimate_filtergram_file_types.data_aef_dbrks_sql_unity_catalog import (
    WHERE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramDbrksSqlUnityCatalog:
    ...
    def test_analyze_estimate_filtergram_approved_dbrks_sql_unity_catalog(self, api_utils):
        """Test analyze, estimate, filtergram approved databricks sql unity catalog."""

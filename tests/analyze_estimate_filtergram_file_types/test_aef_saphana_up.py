...
from data_test.analyze_estimate_filtergram_file_types.data_aef_saphana_up import (
    WHERE_DATE,
    QUERY,
    CONN_NAME,
    ROW_COUNT,
...
class TestAnalyzeEstimateFiltergramSaphanaUp:
    ...
    @pytest.mark.skip(reason="Update test data in DEV-102966")
    def test_analyze_estimate_filtergram_approved_saphana_up(self, api_utils):
        """Test analyze & estimate approved saphana up"""

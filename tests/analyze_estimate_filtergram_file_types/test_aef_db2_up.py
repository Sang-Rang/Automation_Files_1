...
from data_test.analyze_estimate_filtergram_file_types.data_aef_db2_up import (
    TRADE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramDb2Up:
    ...
    def test_analyze_estimate_filtergram_approved_db2_up(self, api_utils):
        """Test analyze, estimate, filtergram approved db2 up."""

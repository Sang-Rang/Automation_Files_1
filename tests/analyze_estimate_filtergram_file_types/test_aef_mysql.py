...
from data_test.analyze_estimate_filtergram_file_types.data_aef_mysql_up import (
    WHERE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramMysqlUp:
    ...
    def test_analyze_estimate_filtergram_approved_mysql_up(self, api_utils):
        """Test analyze, estimate, filtergram approved mysql up."""

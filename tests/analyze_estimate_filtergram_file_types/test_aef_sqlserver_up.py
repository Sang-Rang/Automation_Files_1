...
from data_test.analyze_estimate_filtergram_file_types.data_aef_sqlserver_up import (
    WHERE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramSqlServerUp:
    ...
    def test_analyze_estimate_filtergram_approved_sqlserver_up(self, api_utils):
        """Test analyze, estimate, filtergram approved sequal server up."""

...
from data_test.analyze_estimate_filtergram_file_types.data_aef_dremio_up import (
    WHERE_DATE,
    DATASET,
    QUERY,
    CONN_NAME,
...
class TestAnalyzeEstimateFiltergramDremioUp:
    ...
    def test_analyze_estimate_filtergram_approved_dremio_up(self, api_utils):
        """Test analyze, estimate, filtergram approved dremio up"""

from payloads.pushdown.rules.pl_pd_bq_rules_sales_link_id import (
    ...
    PD_BQ_RULES_SALES_LINK_ID_EXPECTED_RUN_ID,
)

PD_BQ_RULES_SALES_LINK_ID_RULE_DEFINITIONS = [
    {
        "dataset": PD_BQ_RULES_SALES_LINK_ID_DATASET,
        "ruleNm": "stat_rule",
        "ruleType": "SQLF",
        "ruleValue": f"SELECT * FROM @{PD_BQ_RULES_SALES_LINK_ID_DATASET} WHERE $rowCount > 9",
        "points": 1,
        "perc": 1.0,
        "ruleRepo": "",
        "isActive": 1,
    ...
    },
    {
        ...
        "ruleType": "SQLF",
        "ruleValue": f"SELECT SALES FROM @{PD_BQ_RULES_SALES_LINK_ID_DATASET} WHERE SALES = 0",
        "points": 1,
        "perc": 1.0,
        "ruleRepo": "",
        "isActive": 1,
    ...
    },
    {
        ...
        "ruleType": "SQLF",
        "ruleValue": f"SELECT * FROM @{PD_BQ_RULES_SALES_LINK_ID_DATASET} WHERE NAME = 'John' "
    ...
    "data": [
        {
            ...
            "assignmentId": {
                "id": 1585946,
                "uuid": "d19db335-cb46-4230-9828-52f8e5d04f37"
            },
            "dimId": None,
            "dimName": None,
            "ruleCondition": f"SELECT * FROM @{PD_BQ_RULES_SALES_LINK_ID_DATASET} "
                             f"WHERE $rowCount > 9",
            "totalCount": 10,
            "rowsBreaking": 10,
            "tolerance": 0,
        ...
        },
        {
            ...
            "assignmentId": {
                "id": 1585947,
                "uuid": "9ddd65f2-d113-4345-b9d1-7de5026bbaf1"
            },
            "dimId": None,
            "dimName": None,
        ...
        },
        {
            ...
            "assignmentId": {
                "id": 1585948,
                "uuid": "017b8ab5-77b6-46f8-8908-4da105f80dc5"
            },
            "dimId": None,
            "dimName": None,
        ...
        },
        {
            ...
            "assignmentId": {
                "id": 1585945,
                "uuid": "a75e31d6-9bfa-406e-b56c-5ff106639d68"
            },
            "dimId": None,
            "dimName": None,
            "ruleCondition": f"SELECT SALES FROM @{PD_BQ_RULES_SALES_LINK_ID_DATASET} "
                             f"WHERE SALES = 0",
            "totalCount": 10,
            "rowsBreaking": 1,
            "tolerance": 0,
        ...
        },
        {
            ...
            "assignmentId": {
                "id": 1585944,
                "uuid": "c6b93891-bb7f-4e2b-ba24-3a47e7bc2e67"
            },
            "dimId": None,
            "dimName": None,
            "ruleCondition": f"SELECT * FROM @{PD_BQ_RULES_SALES_LINK_ID_DATASET} "
...
PD_BQ_RULES_SALES_LINK_ID_EXPECTED_CSV_OUTPUT = [
    ...
    f"{PD_BQ_RULES_SALES_LINK_ID_DATASET},{PD_BQ_RULES_SALES_LINK_ID_EXPECTED_RUN_ID},"
...
PD_BQ_RULES_SALES_LINK_ID_EXPECTED_JSON_OUTPUT = [
    {
        "dataset": PD_BQ_RULES_SALES_LINK_ID_DATASET,
        "runId": PD_BQ_RULES_SALES_LINK_ID_EXPECTED_RUN_ID,

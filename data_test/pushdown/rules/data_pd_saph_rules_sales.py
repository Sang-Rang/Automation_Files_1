from payloads.pushdown.rules.pl_pd_saph_rules_sales import PD_SAPH_RULES_SALES_DATASET
...
PD_SAPH_RULES_SALES_RULE_DEFINITIONS = [
    {
        ...
        "ruleNm": "stat_rule",
        "ruleType": "SQLF",
        "ruleValue": f"SELECT * FROM @{PD_SAPH_RULES_SALES_DATASET} WHERE $rowCount > 9",
        "points": 1,
        "perc": 1.0,
        "ruleRepo": "",
        "isActive": 1,
    ...
    },
    {
        ...
        "ruleType": "SQLF",
        "ruleValue": f"SELECT SALES FROM @{PD_SAPH_RULES_SALES_DATASET} WHERE SALES = 0",
        "points": 1,
        "perc": 1.0,
        "ruleRepo": "",
        "isActive": 1,
    ...
    },
    {
        ...
        "ruleType": "SQLF",
        "ruleValue": f"SELECT * FROM @{PD_SAPH_RULES_SALES_DATASET} WHERE NAME = 'John' "
    ...
    "data": [
        {
            ...
            "dimId": None,
            "dimName": None,
            "ruleCondition": f"SELECT * FROM @{PD_SAPH_RULES_SALES_DATASET} WHERE $rowCount > 9",
            "totalCount": 10,
            "rowsBreaking": 10,
            "tolerance": 0,
            "ruleStatus": None
        ...
        },
        {
            ...
            "dimId": None,
            "dimName": None,
            "ruleCondition": f"SELECT SALES FROM @{PD_SAPH_RULES_SALES_DATASET} WHERE SALES = 0",
            "totalCount": 10,
            "rowsBreaking": 1,
            "tolerance": 0,
            "ruleStatus": None
        },
        {
            ...
            "dimId": None,
            "dimName": None,
            "ruleCondition": f"SELECT * FROM @{PD_SAPH_RULES_SALES_DATASET} WHERE NAME = 'John' "
                             f"AND TRDATE = '2022-05-01' AND SALES = 1000",
            "totalCount": 10,
            "rowsBreaking": 1,
            "tolerance": 0,

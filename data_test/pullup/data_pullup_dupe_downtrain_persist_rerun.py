...
PULLUP_DUPE_DWTR_RETRAIN_CONN = "APPROVED_BIGQUERY_KEY"
PULLUP_DUPE_DWTR_RETRAIN_DS = "AUTO_DUPE_DWTR_RETRAIN" + str(now)
...
PL_DUPE_DWTR_DS_DEFS = {
    ...
    "load": {
        ...
        "connectionUrl": "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId="
                         "owl-hadoop-cdh;OAuthType=0;OAuthServiceAcctEmail=1096839723485-"
                         "compute@developer.gserviceaccount.com;OAuthPvtKeyPath=/tmp/keytab/"
                         "bigquery.json;Timeout=86400",
        "userName": "admin",
        "password": "",
    ...
    "spark": {
        ...
        "executorMemory": "2g",
        "executorCores": 1,
        "conf": "spark.kubernetes.memoryOverheadFactor=0.4,spark.kubernetes.executor.pod"
                "TemplateFile=local:///opt/owl/config/k8s-executor-template.yml,spark."

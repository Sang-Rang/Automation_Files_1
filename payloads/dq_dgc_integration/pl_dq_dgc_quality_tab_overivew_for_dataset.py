...
DS_DEF_QUALITY_TAB_OVERVIEW_FOR_DATASET_NAME = (
    "AUTO_DGC_QUALITY_TAB_FOR_DATASET_" + datetime.now().strftime("%Y%m%d%H%M%S")
)
...
DS_DEF_DGC_QUALITY_TAB_OVERVIEW_FOR_DATASET = {
    ...
    "pgUser": "",
    "pgPassword": "",
    "host": "10.64.2.3:5432/rc202408?currentSchema=validation",
    "port": "5432/rc202408?currentSchema=validation",
    "user": "susmitha",
    "alertEmail": None,
    "scheduleTime": None,
    "schemaScore": 1,
    ...
    "shape": {
        ...
        "granular": False,
        "columnSettings": [
            {"enabled": True, "name": "cost", "type": "Decimal"},
            {"enabled": True, "name": "cost_code", "type": "String, Double"},
            {"enabled": True, "name": "cost_description", "type": "String"},
            {"enabled": True, "name": "daily_id", "type": "Long, String, Int"},
            {"enabled": True, "name": "email", "type": "String"},
            {"enabled": True, "name": "first_name", "type": "String"},
            {"enabled": True, "name": "last_name", "type": "String"},
            {"enabled": True, "name": "lost_column", "type": "Int"},
            {"enabled": True, "name": "sale_state", "type": "String"},
            {"enabled": True, "name": "sales_id", "type": "Int"},
            {"enabled": True, "name": "sales_rep", "type": "String"},
            {"enabled": True, "name": "state_tax", "type": "Decimal"},
            {"enabled": True, "name": "transaction_date", "type": "Timestamp"},
            {"enabled": True, "name": "transaction_time", "type": "String"},
            {"enabled": True, "name": "vendor_type", "type": "String"},
        ],
    },
    "jobSchedule": None,

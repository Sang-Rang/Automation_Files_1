...
DS_DEF_DGC_DATASET_UPDATES_NAME = "AUTO_DQ_DGC_DYNAMIC_UPDATES_" + datetime.now().strftime(
    "%Y%m%d%H%M%S"
)
...
DS_DEF_DGC_DATASET_UPDATES = {
    ...
    "env": {"dataset": DS_DEF_DGC_DATASET_UPDATES_NAME, "jdbcPrincipal": "", "jdbcKeyTab": ""},
    "record": {
        "on": False,
        "in": "",
        "notIn": "",

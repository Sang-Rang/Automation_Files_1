...
DS_DEF_DGC_USER_DEFINED_RULES_NAME = "AUTO_DQ_DGC_USER_DEFINED_RULES_" + datetime.now().strftime(
    "%Y%m%d%H%M%S"
)
...
DS_DEF_DGC_USER_DEFINED_RULES = {
    ...
    "pgUser": "",
    "pgPassword": "",
    "host": "10.64.2.3:5432/rc202407?currentSchema=automation",
    "port": "5432/rc202407?currentSchema=automation",
    "user": "misha",
    "alertEmail": None,
    "scheduleTime": None,
    "schemaScore": 1,
    "optionAppend": "",
    "keyDelimiter": "~~",
    "agentId": {"id": 6, "uuid": "90dfba13-36eb-424a-ba2a-c65a180a67f9"},
    "load": {
        "readonly": False,
    ...
    "env": {"dataset": DS_DEF_DGC_USER_DEFINED_RULES_NAME, "jdbcPrincipal": "", "jdbcKeyTab": ""},
    "record": {
        "on": False,
        "in": "",
        "notIn": "",

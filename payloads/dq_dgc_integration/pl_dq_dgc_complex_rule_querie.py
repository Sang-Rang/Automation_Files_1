...
DS_DEF_DGC_COMPLEX_RULE_NAME = "AUTO_DQ_DGC_COMPLEX_RULE_" + datetime.now().strftime("%Y%m%d%H%M%S")
...
DS_DEF_DGC_COMPLEX_RULE = {
    ...
    "env": {"dataset": DS_DEF_DGC_COMPLEX_RULE_NAME, "jdbcPrincipal": "", "jdbcKeyTab": ""},
    "record": {
        "on": False,
        "in": "",
        "notIn": "",
    ...
    "shape": {
        ...
        "granular": False,
        "columnSettings": [
            {"enabled": True, "name": "close", "type": "Double, Int"},
            {"enabled": True, "name": "exch", "type": "String"},
            {"enabled": True, "name": "high", "type": "Double, Int"},
            {"enabled": True, "name": "low", "type": "Decimal"},
            {"enabled": True, "name": "open", "type": "Double, Int"},
            {"enabled": True, "name": "part_date_str", "type": "Timestamp"},
            {"enabled": True, "name": "symbol", "type": "String"},
            {"enabled": True, "name": "trade_date", "type": "Timestamp"},
            {"enabled": True, "name": "volume", "type": "Decimal"},
        ],
    },
    "jobSchedule": None,
    "connectionType": "PULLUP",
}
DS_DEF_DGC_COMPLEX_RULE_SECONDARY_NAME = "AUTO_DQ_DGC_COMPLEX_RULE_2"
DS_DEF_DGC_COMPLEX_RULE_SECONDARY = copy.deepcopy(DS_DEF_DGC_COMPLEX_RULE)
DS_DEF_DGC_COMPLEX_RULE_SECONDARY["dataset"] = DS_DEF_DGC_COMPLEX_RULE_SECONDARY_NAME

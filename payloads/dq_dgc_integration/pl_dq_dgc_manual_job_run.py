...
DS_DEF_DGC_INTEGRATION_NO_BU_JOB_NAME = "AUTO_DQ_DGC_INTEGRATION_NO_BU_" + datetime.now().strftime(
    "%Y%m%d%H%M%S"
)
...
DS_DEF_DGC_INTEGRATION_WITH_BU_JOB_NAME = (
    "AUTO_DQ_DGC_INTEGRATION_WITH_BU_" + datetime.now().strftime("%Y%m%d%H%M%S")
)

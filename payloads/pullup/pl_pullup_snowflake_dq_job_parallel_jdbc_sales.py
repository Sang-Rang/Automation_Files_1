...
PULLUP_SNOWFLAKE_DQ_JOB_PARALLEL_JDBC_SALES_DATASET = ("AUTO_PULLUP_SNOWFLAKE_DQ_"
                                                       "JOB_PARALLEL_JDBC_SALES")

PULLUP_SNOWFLAKE_DQ_JOB_PARALLEL_JDBC_SALES_PAYLOAD = {
    "dataset": PULLUP_SNOWFLAKE_DQ_JOB_PARALLEL_JDBC_SALES_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    ...
    "port": "5432/dev?currentSchema=public",
    "user": "rahul",
    "alertEmail": None,
    "scheduleTime": None,
    "schemaScore": 1,
    ...
    "spark": {
        ...
        "executorMemory": "1g",
        "executorCores": 1,
        "conf": "spark.kubernetes.memoryOverheadFactor=0.4,spark.kubernetes.executor.podTemplateF"
                "ile=local:///opt/owl/config/k8s-executor-template.yml,spark.kubernetes.driver.pod"
                "TemplateFile=local:///opt/owl/config/k8s-driver-template.yml",
        "queue": "",
        "master": "k8s://",
        "principal": "",
        "keyTab": "",

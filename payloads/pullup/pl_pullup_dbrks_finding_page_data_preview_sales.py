from utils.constants import PROD_HOST, PROD_RUN_ID

PULLUP_DBRKS_DATA_PREVIEW_SALES_PROFILE_DATASET = "AUTO_PULLUP_DBRKS_DATA_PREVIEW_SALES_PROFILE"
PULLUP_DBRKS_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE_PAYLOAD = {
    "dataset": PULLUP_DBRKS_DATA_PREVIEW_SALES_PROFILE_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "load": {
        ...
        "multiLine": False,
        "lib": "/opt/owl/drivers/databricks/",
        "additionalLib": "",
        "driverName": "cdata.jdbc.databricks.DatabricksDriver",
        "connectionName": "APPROVED_CDATA_DATABRICKS_UP",
        "connectionUrl": "",
        "userName": "",
        "password": "",

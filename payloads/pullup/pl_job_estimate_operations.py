...
from utils.constants import PROD_HOST, PROD_PORT, BASE_CREDS, PROD_RUN_ID

JOB_ESTIMATE_ORACLE = "AUTO_EXPLORER_ESTIMATE_ORACLE"

DS_ESTIMATE_ORACLE = {
    "dataset": JOB_ESTIMATE_ORACLE,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "load": {
        ...
        "alias": "",
        "query": "select * from OWLUSER.NYSE where TRADE_DATE = '${rd}'",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,
...
# --------------------------------------------DB2---------------------------------------------------
JOB_ESTIMATE_DB2 = "AUTO_EXPLORER_ESTIMATE_DB2"

DS_ESTIMATE_DB2 = {
    "dataset": JOB_ESTIMATE_DB2,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
...
# ----------------------------------------------POSTGRES -------------------------------------------
JOB_ESTIMATE_POSTGRES = "AUTO_EXPLORER_ESTIMATE_POSTGRES"

DS_ESTIMATE_POSTGRES = {
    "dataset": JOB_ESTIMATE_POSTGRES,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,

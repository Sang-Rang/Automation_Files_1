...
PULLUP_TRINO_DQ_JOB_PARALLEL_JDBC_SALES_DATASET = "AUTO_PULLUP_TRINO_DQ_JOB_PARALLEL_JDBC_SALES"

PULLUP_TRINO_DQ_JOB_PARALLEL_JDBC_SALES_PAYLOAD = {
    "dataset": PULLUP_TRINO_DQ_JOB_PARALLEL_JDBC_SALES_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "load": {
        ...
        "alias": "",
        "query": "select sales1.name, sales2.sales, sales2.trdate from public.sales sales1 "
                 "join public.sales sales2 on sales1.trdate = sales2.trdate "
                 "where sales1.name = 'John' and sales2.sales = 1000\n",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,
        ...
        "multiLine": False,
        "lib": "/opt/owl/drivers/trino",
        "additionalLib": "",
        "driverName": "io.trino.jdbc.TrinoDriver",
        "connectionName": "APPROVED_TRINO_UP",
        "connectionUrl": "",
        "userName": "",
        "password": "",

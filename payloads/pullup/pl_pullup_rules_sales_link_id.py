...
PULLUP_RULES_SALES_LINK_ID_DATASET = "AUTO_PULLUP_RULES_SALES_LINK_ID"
PULLUP_RULES_SALES_LINK_ID_EXPECTED_RUN_ID = BaseHelper.format_datetime_for_break_run_id_download(
    PROD_RUN_ID
)

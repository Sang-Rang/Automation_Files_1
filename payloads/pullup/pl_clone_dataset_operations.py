...
from utils.constants import PROD_HOST, PROD_PORT, BASE_CREDS, PROD_AGENT_UUID, PROD_RUN_ID

CLONE_DS_NAME = "AUTO_DQJOB_CLONE"

CLONE_DS_PAYLOAD = {
    "dataset": CLONE_DS_NAME,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "optionAppend": "",
    "keyDelimiter": "~~",
    "agentId": {"id": 0, "uuid": PROD_AGENT_UUID},
    "load": {
        "dataset": CLONE_DS_NAME,
        "readonly": False,

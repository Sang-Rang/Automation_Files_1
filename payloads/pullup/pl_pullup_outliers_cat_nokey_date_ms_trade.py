PULLUP_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_DATASET = "AUTO_PULLUP_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE"

PULLUP_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_PAYLOAD = {
    "dataset": PULLUP_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_DATASET,
    "runId": "2023-01-10",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "port": "5432/rc202308?currentSchema=validation",
    "user": "gaberosenadmin",
    "alertEmail": "",
    "scheduleTime": None,
    "schemaScore": 1,
    ...
    "agentId": {
        "id": 10,
        "uuid": "d4279cbc-2358-419b-ae33-f66034149cac"
    },
    "load": {
        "dataset": PULLUP_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_DATASET,
        "readonly": False,
        ...
        "alias": "",
        "query": "select * from PUBLIC.MS_TRADE where TRADE_DATE = '${rd}'",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,

...
from utils.constants import BASE_CREDS, PROD_HOST, PROD_RUN_ID, PROD_PORT

SHAPE_SETTINGS_DS_NAME = "AUTO_SHAPES_SETTINGS"
...
SHAPE_SETTINGS_PAYLOAD = {
    ...
    "load": {
        ...
        "alias": "",
        "query": "select * from public.semantic_test",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,

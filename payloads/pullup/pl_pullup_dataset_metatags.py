PL_PULLUP_DATASET_WITH_METATAGS = {
    "dataset": "AUTO_PU_METATAGS_VIA_API",
    "runId": "2025-01-22",
    "runIdEnd": "",
    ...
    "optionAppend": "",
    "keyDelimiter": "~~",
    "agentId": {"id": 1, "uuid": "f736b2f6-a9ea-4c91-901b-1df25768cc9b"},
    "load": {
        "dataset": "AUTO_PU_METATAGS_VIA_API",
        "readonly": False,
    ...
    "env": {"dataset": "AUTO_PU_METATAGS_VIA_API", "jdbcPrincipal": "", "jdbcKeyTab": ""},
    "stream": None,
    "record": {
        "dataset": None,
        "on": False,

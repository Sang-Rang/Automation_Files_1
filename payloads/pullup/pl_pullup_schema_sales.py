...
PULLUP_SCHEMA_SALES_DATASET = "AUTO_PULLUP_SCHEMA_SALES"

PULLUP_SCHEMA_SALES_PAYLOAD = {
    "dataset": PULLUP_SCHEMA_SALES_DATASET,
    "runId": "2022-05-04",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pgUser": "",
    "pgPassword": "",
    "host": "10.64.2.3:5432/rc202407?currentSchema=validation",
    "port": None,
    ...
    "agentId": {
        "id": 6,
        "uuid": "90dfba13-36eb-424a-ba2a-c65a180a67f9"
    },
    "load": {
        "readonly": False,
        "passwordManager": None,
        "alias": "",
        "query": "select * from TEST.SALES where TRDATE = '${rd}'",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,
...
PULLUP_SCHEMA_SALES_MISSING_COLUMN_PAYLOAD = copy.deepcopy(PULLUP_SCHEMA_SALES_PAYLOAD)
PULLUP_SCHEMA_SALES_MISSING_COLUMN_PAYLOAD["load"]["query"] = (
    "select NAME, TRDATE from TEST.SALES where TRDATE = '${rd}'"
)

...
ATHENA_DATA_PREVIEW_SALES_PROFILE_DATASET = "AUTO_PULLUP_ATHENA_DS_DATA_PREVIEW_SALES_PROFILE"
PULLUP_ATHENA_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE_PAYLOAD = {
    "dataset": ATHENA_DATA_PREVIEW_SALES_PROFILE_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "load": {
        ...
        "alias": "",
        "query": "select name, CAST(trdate as TIMESTAMP) as trdate, sales from default.sales",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,

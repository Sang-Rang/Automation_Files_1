...
PULLUP_COMPLEX_RULE_FREEFORM_DATASET = "AUTO_RULES_COMPLEX2TABLES"
PULLUP_COMPLEX_RULE_FREEFORM_SECONDARY_DATASET = "AUTO_RULES_COMPLEX2TABLES1"
...
PULLUP_COMPLEX_RULE_FREEFORM_PAYLOAD = {
    ...
    "load": {
        ...
        "alias": "",
        "query": "select * from samples.austin_crime",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,
        ...
        "connectionUrl": "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId="
                         "owl-hadoop-cdh;OAuthType=0;OAuthServiceAcctEmail="
                         "1096839723485-compute@developer.gserviceaccount.com;OAuthPvtKeyPath="
                         "/tmp/keytab/bigquery.json;Timeout=86400",
        "userName": "admin",
        "password": "",
...
PULLUP_COMPLEX_RULE_FREEFORM_SECONDARY_PAYLOAD = {
    "dataset": PULLUP_COMPLEX_RULE_FREEFORM_SECONDARY_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,

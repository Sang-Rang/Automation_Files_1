...
PULLUP_RULES_S3_TO_JDBC_CONNECTION = "APPROVED_S3_KEY"
PULLUP_RULES_S3_TO_JDBC_DATASET = "AUTO_RULES_S3TOJDBC"
...
PULLUP_RULES_S3_TO_JDBC_PAYLOAD = {
    ...
    "load": {
        ...
        "timestamp": False,
        "filePath": "s3a://cdq-datasets-hr7wprr/customer_newid/"
                    "part-00000-62add221-5ac5-4b60-a263-77724123aeea-c000.csv",
        "fileQuery": "",
        "fullFile": True,
        "fileHeader": None,
        "inferSchema": True,
        ...
        "additionalLib": "/opt/owl/drivers/mssql/",
        "driverName": "remoteFileConnDriver",
        "connectionName": PULLUP_RULES_S3_TO_JDBC_CONNECTION,
        "connectionUrl": "",
        "userName": "",
        "password": "",

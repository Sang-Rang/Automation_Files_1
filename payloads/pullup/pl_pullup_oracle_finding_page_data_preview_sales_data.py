...
PULLUP_ORACLE_DATASET_DATA_PREVIEW_SALES_REP_DATASET = "AUTO_PULLUP_ORACLE_DATA_PREVIEW_SALES_REP"

PULLUP_ORACLE_FINDING_PAGE_DATA_PREVIEW_SALES_REP_PAYLOAD = {
    "dataset": PULLUP_ORACLE_DATASET_DATA_PREVIEW_SALES_REP_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "load": {
        ...
        "alias": "",
        "query": "select * from OWLUSER.SALES_REP",
        "queryHistory": "",
        "key": "",
        "expression": "",
        "addDateColumn": False,

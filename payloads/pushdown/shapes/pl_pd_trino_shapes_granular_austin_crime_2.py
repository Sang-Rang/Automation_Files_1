...
PD_TRINO_SHAPES_GRANULAR_AUSTIN_CRIME_2_DATASET = "AUTO_PD_TRINO_SHAPES_GRANULAR_AUSTIN_CRIME_2"

PD_TRINO_SHAPES_GRANULAR_AUSTIN_CRIME_2_PAYLOAD = {
    "dataset": PD_TRINO_SHAPES_GRANULAR_AUSTIN_CRIME_2_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
...
PD_TRINO_SHAPES_GRANULAR_AUSTIN_CRIME_2_SHAPES_SETTINGS = {
    ...
    "dataShapeColType[address]": "varchar(16777216)",
    "dataShapeColType[census_tract]": "double",
    "dataShapeColType[clearance_date]": "TIMESTAMP",
    "dataShapeColType[clearance_status]": "varchar(16777216)",
    "dataShapeColType[council_district_code]": "decimal(38,0)",
    "dataShapeColType[description]": "varchar(16777216)",
    "dataShapeColType[district]": "varchar(16777216)",
    "dataShapeColType[latitude]": "double",
    "dataShapeColType[location]": "varchar(16777216)",
    "dataShapeColType[location_description]": "varchar(16777216)",
    "dataShapeColType[longitude]": "double",
    "dataShapeColType[primary_type]": "varchar(16777216)",
    "dataShapeColType[timestamp]": "TIMESTAMP",
    "dataShapeColType[unique_key]": "decimal(38,0)",
    "dataShapeColType[x_coordinate]": "decimal(38,0)",
    "dataShapeColType[y_coordinate]": "decimal(38,0)",
    "dataShapeColType[year]": "decimal(38,0)",
    "dataShapeColType[zipcode]": "varchar(16777216)",
}

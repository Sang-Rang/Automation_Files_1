...
PD_SF_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SNOWFLAKE_PUSHDOWN"
PD_SF_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SF_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS"
)

PD_SF_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    "runId": PROD_RUN_ID,
    "dataset": PD_SF_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1

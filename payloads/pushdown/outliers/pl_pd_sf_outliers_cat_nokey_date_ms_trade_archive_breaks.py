PD_SF_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SNOWFLAKE_PUSHDOWN"
PD_SF_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SF_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS"
)

PD_SF_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_PAYLOAD = {
    "runId": "2023-01-10",
    "dataset": PD_SF_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1
    ...
    "alertEmail": "",
    "pushdown": {
        "connectionName": PD_SF_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,

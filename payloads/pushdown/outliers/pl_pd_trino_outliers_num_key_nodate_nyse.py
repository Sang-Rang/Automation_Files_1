...
PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_DATASET = "AUTO_PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE"

PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_PAYLOAD = {
    "dataset": PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1567,
                "dataset": "temDataset_57a3f4b71c094f2ab6993e8cd774eeb9",
                "only": False,
                "lookback": 5,
                "key": [
                    "symbol"

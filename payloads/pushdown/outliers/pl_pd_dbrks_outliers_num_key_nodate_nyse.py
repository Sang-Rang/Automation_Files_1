...
PD_DBRKS_OUTLIERS_NUM_KEY_NODATE_NYSE_DATASET = "AUTO_PD_DBRKS_OUTLIERS_NUM_KEY_NODATE_NYSE"

PD_DBRKS_OUTLIERS_NUM_KEY_NODATE_NYSE_PAYLOAD = {
    "runId": PROD_RUN_ID,
    "dataset": PD_DBRKS_OUTLIERS_NUM_KEY_NODATE_NYSE_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
      "id": -1
    ...
    "pushdown": {
      ...
      "maxConnections": 10,
      "sourceQuery": "select * from default.nyse",
      "backRuns": 0,
      "backRunBin": "DAY",
      "threads": 2,
      "key": ""

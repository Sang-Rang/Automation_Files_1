PD_TRINO_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS"
)
...
PD_TRINO_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "pushdown": {
        "dataset": PD_TRINO_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_TRINO_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
        "sourceQuery": "select * from public.ms_trade where trade_date = TIMESTAMP '${rd}'",
        "backRuns": 5,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2016,
                "dataset": "temDataset_b04132e0653a4da49988254851f1e87f",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

PD_SAPH_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SAPHANA_PUSHDOWN"
PD_SAPH_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS"
)

PD_SAPH_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
	"dataset": PD_SAPH_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
	"runId": "2018-01-12",
	"runIdEnd": "",
	"runState": "DRAFT",
	"passFail": 1,
	...
	"pushdown": {
		"dataset": PD_SAPH_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
		"connectionName": PD_SAPH_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
		"maxConnections": 10,
	...
	"outlierConfiguration": {
		...
		"configurations": [
			{
				"id": 2296,
				"dataset": "temDataset_59879c06c59b4902834f79aa90e75d02",
				"only": False,
				"lookback": 5,
				"lookbackQuery": "",
				"key": [

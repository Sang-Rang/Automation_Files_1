...
PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_CONNECTION = (
    "APPROVED_SAPHANA_PUSHDOWN"
)
PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS"
)
...
PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "pushdown": {
        "dataset": PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
        "sourceQuery": "select * from TEST.US_AIRPORTS",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2274,
                "dataset": "temDataset_7ec8a507140b41d9aa1acb3b7bb8928a",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": None,

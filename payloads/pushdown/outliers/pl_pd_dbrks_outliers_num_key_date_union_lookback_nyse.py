PD_DBRKS_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE_DATASET = (
    "AUTO_PD_DBRKS_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE"
)

PD_DBRKS_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE_PAYLOAD = {
    "dataset": PD_DBRKS_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE_DATASET,
    "runId": "2018-01-16",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2123,
                "dataset": "temDataset_7a856421162649679b02ddd45cc35bcc",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

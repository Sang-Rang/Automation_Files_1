PD_TRINO_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS"
)
...
PD_TRINO_OUTLIERS_CAT_NOKEY_DATE_MS_TRADE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2029,
                "dataset": "temDataset_be55c960bad645f6bb2823d0985ce625",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": None,

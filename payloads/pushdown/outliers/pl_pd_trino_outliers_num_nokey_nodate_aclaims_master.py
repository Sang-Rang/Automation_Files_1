...
PD_TRINO_OUTLIERS_NUM_NOKEY_NODATE_ACLAIMS_MASTER_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_NUM_NOKEY_NODATE_ACLAIMS_MASTER"
)

PD_TRINO_OUTLIERS_NUM_NOKEY_NODATE_ACLAIMS_MASTER_PAYLOAD = {
    "dataset": PD_TRINO_OUTLIERS_NUM_NOKEY_NODATE_ACLAIMS_MASTER_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1569,
                "dataset": "temDataset_c6243390d8794e8ca0f9884428bca633",
                "only": False,
                "lookback": 5,
                "key": None,
                "include": [

PD_TRINO_OUTLIERS_NUM_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_NUM_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_NUM_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS"
)
...
PD_TRINO_OUTLIERS_NUM_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1615,
                "dataset": "temDataset_ca113c8055a048968712ced2da8b4c35",
                "only": False,
                "lookback": 5,
                "key": [
                    "trade_id"

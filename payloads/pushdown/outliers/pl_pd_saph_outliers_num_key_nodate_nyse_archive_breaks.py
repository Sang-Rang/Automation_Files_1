...
PD_SAPH_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SAPHANA_PUSHDOWN"
PD_SAPH_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS"
)
...
PD_SAPH_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
	...
	"pushdown": {
		"dataset": PD_SAPH_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET,
		"connectionName": PD_SAPH_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
		"maxConnections": 10,
	...
	"outlierConfiguration": {
		...
		"configurations": [
			{
				"id": 2332,
				"dataset": "temDataset_0a294b0b90064a178665d317ccbedd2a",
				"only": False,
				"lookback": 5,
				"lookbackQuery": "",
				"key": [

...
PD_TRINO_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS"
)
...
PD_TRINO_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "pushdown": {
        "dataset": PD_TRINO_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_TRINO_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2043,
                "dataset": "temDataset_47f1f4526fa043869755b3f7ef42c041",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": None,

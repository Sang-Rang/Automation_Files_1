...
PD_SF_OUTLIERS_NUM_NOKEY_NODATE_EMPLOYEES_DATASET = "AUTO_PD_SF_OUTLIERS_NUM_NOKEY_NODATE_EMPLOYEES"

PD_SF_OUTLIERS_NUM_NOKEY_NODATE_EMPLOYEES_PAYLOAD = {
    "runId": PROD_RUN_ID,
    "dataset": PD_SF_OUTLIERS_NUM_NOKEY_NODATE_EMPLOYEES_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1

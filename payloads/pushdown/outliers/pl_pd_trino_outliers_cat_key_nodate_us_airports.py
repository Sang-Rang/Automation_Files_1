...
PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS"
)

PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_PAYLOAD = {
    "dataset": PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2002,
                "dataset": "temDataset_ba421bf64a6440dda7e4cdf5665ba976",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

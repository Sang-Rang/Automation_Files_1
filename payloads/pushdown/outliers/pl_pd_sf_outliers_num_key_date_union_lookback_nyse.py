PD_SF_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE_DATASET = (
    "AUTO_PD_SF_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE"
)

PD_SF_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE_PAYLOAD = {
    "dataset": PD_SF_OUTLIERS_NUM_KEY_DATE_UNION_LOOKBACK_NYSE_DATASET,
    "runId": "2018-01-16",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2092,
                "dataset": "temDataset_1762d27d22934559bc799aef1c389f1c",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

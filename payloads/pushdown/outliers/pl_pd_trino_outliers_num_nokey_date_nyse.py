PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_DATASET = "AUTO_PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE"

PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_PAYLOAD = {
    "dataset": PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_DATASET,
    "runId": "2018-01-12",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1568,
                "dataset": "temDataset_7c09d4ff7e6a42798fa66f19f3f5e665",
                "only": False,
                "lookback": 5,
                "key": None,
                "include": [

...
PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SAPHANA_PUSHDOWN"
PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS"
)

PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    "dataset": PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        "dataset": PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_SAPH_OUTLIERS_CAT_NOKEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2271,
                "dataset": "temDataset_bf64bce68a3f4a02927a047dffde9185",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": None,

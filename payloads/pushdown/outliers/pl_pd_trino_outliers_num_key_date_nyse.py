PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_DATASET = "AUTO_PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE"

PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_PAYLOAD = {
    "dataset": PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_DATASET,
    "runId": "2018-01-12",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1566,
                "dataset": "temDataset_e3e56785f9f843ae860906fce2545f3a",
                "only": False,
                "lookback": 5,
                "key": [
                    "symbol"

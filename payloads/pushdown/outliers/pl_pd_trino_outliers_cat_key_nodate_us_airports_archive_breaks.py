...
PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS"
)
...
PD_TRINO_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2026,
                "dataset": "temDataset_f783af30598949f5ae39e7b4a8509da4",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

PD_SAPH_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SAPHANA_PUSHDOWN"
PD_SAPH_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS"
)

PD_SAPH_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
  "dataset": PD_SAPH_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
  "runId": "2018-01-12",
  "runIdEnd": "",
  "runState": "DRAFT",
  "passFail": 1,
  ...
  "pushdown": {
    "dataset": PD_SAPH_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
    "connectionName": PD_SAPH_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
    "maxConnections": 10,
    "sourceQuery": "select * from TEST.NYSE where TRADE_DATE = '${rd}'",
    "backRuns": 5,
    "backRunBin": "DAY",
    "dateFormatType": "DATE",
    "threads": 2,
  ...
  "outlierConfiguration": {
    ...
    "configurations": [
      {
        "id": 2339,
        "dataset": "temDataset_309fd2b81a6a4ca08f638f7f4ca84fac",
        "only": False,
        "lookback": 5,
        "lookbackQuery": "",
        "key": None,

...
PD_SAPH_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SAPHANA_PUSHDOWN"
PD_SAPH_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS"
)
...
PD_SAPH_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "pushdown": {
        "dataset": PD_SAPH_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_SAPH_OUTLIERS_CAT_KEY_NODATE_US_AIRPORTS_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2263,
                "dataset": "temDataset_20c0eeb17c7842b38ff5193ec69e4a18",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

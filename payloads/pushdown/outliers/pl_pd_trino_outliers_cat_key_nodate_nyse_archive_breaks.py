...
PD_TRINO_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS"
)
...
PD_TRINO_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2023,
                "dataset": "temDataset_53d77874d24f4a929c4c82ad832244f7",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

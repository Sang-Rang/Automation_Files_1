PD_SAPH_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SAPHANA_PUSHDOWN"
PD_SAPH_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS"
)
...
PD_SAPH_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "pushdown": {
        "dataset": PD_SAPH_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_SAPH_OUTLIERS_CAT_KEY_DATE_MS_TRADE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2246,
                "dataset": "temDataset_f7f425499db14f848b19f14b256a2bd3",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

PD_DBRKS_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_DATABRICKS_PUSHDOWN"
PD_DBRKS_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_DBRKS_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS"
)

PD_DBRKS_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    "runId": "2018-01-12",
    "dataset": PD_DBRKS_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1
    ...
    "alertEmail": "",
    "pushdown": {
        "connectionName": PD_DBRKS_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,

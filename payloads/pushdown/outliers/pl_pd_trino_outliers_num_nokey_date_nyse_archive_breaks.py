PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS"
)

PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    "dataset": PD_TRINO_OUTLIERS_NUM_NOKEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
    "runId": "2018-01-12",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1629,
                "dataset": "temDataset_e3c15e5db31542ecaa2eda6346ee38f8",
                "only": False,
                "lookback": 5,
                "key": None,
                "include": [

PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS"
)

PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    "dataset": PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
    "runId": "2018-01-12",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        "dataset": PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_TRINO_OUTLIERS_NUM_KEY_DATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1620,
                "dataset": "temDataset_eba16ba817614574ad98e5e0a6cbd636",
                "only": False,
                "lookback": 5,
                "key": [
                    "symbol"

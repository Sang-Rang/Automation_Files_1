...
PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_TRINO_PUSHDOWN"
PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS"
)
...
PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "pushdown": {
        "dataset": PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET,
        "connectionName": PD_TRINO_OUTLIERS_NUM_KEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,
        "sourceQuery": "select * from public.nyse_99k",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1625,
                "dataset": "temDataset_e62833596b1b4e95b335f3f590d8e30f",
                "only": False,
                "lookback": 5,
                "key": [
                    "symbol"

...
PD_SAPH_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SAPHANA_PUSHDOWN"
PD_SAPH_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_DATASET = (
    "AUTO_PD_SAPH_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS"
)
...
PD_SAPH_OUTLIERS_CAT_KEY_NODATE_NYSE_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2260,
                "dataset": "temDataset_7e84ecd51c6e4d8681d2b40f0ec7b56d",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

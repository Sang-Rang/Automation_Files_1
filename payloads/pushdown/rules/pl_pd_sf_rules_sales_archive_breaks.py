...
PD_SF_RULES_SALES_ARCHIVE_BREAKS_CONNECTION = "APPROVED_SNOWFLAKE_PUSHDOWN"
PD_SF_RULES_SALES_ARCHIVE_BREAKS_DATASET = "AUTO_PD_SF_RULES_SALES_ARCHIVE_BREAKS"
...
PD_SF_RULES_SALES_ARCHIVE_BREAKS_PAYLOAD = {
    ...
    "alertEmail": "",
    "pushdown": {
        "connectionName": PD_SF_RULES_SALES_ARCHIVE_BREAKS_CONNECTION,
        "maxConnections": 10,

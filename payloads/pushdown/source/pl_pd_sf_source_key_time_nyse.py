PD_SF_SOURCE_KEY_TIME_NYSE_DATASET = "AUTO_PD_SF_SOURCE_KEY_TIME_NYSE"

PD_SF_SOURCE_KEY_TIME_NYSE_PAYLOAD = {
    "dataset": PD_SF_SOURCE_KEY_TIME_NYSE_DATASET,
    "runId": "2018-01-16",
    "runIdEnd": "",
    "runDateAdjustment": "",
    "runState": "DRAFT",
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select \"EXCH\", \"SYMBOL\", \"TRADE_DATE\", \"OPEN\", \"HIGH\", "
                       "\"CLOSE\", \"VOLUME\", \"PART_DATE_STR\" from PUBLIC.NYSE where "
                       "\"TRADE_DATE\" = '${rd}'",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
    ...
    "source": {
        ...
        "connectionName": "APPROVED_SNOWFLAKE_PUSHDOWN",
        "connectionUrl": "",
        "query": "select * from PUBLIC.NYSE where TRADE_DATE = '2018-01-15'",

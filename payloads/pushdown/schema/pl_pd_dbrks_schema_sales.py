...
PD_DBRKS_SCHEMA_SALES_DATASET = "AUTO_PD_DBRKS_SCHEMA_SALES"
...
PD_DBRKS_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD = copy.deepcopy(PD_DBRKS_SCHEMA_SALES_PAYLOAD)
PD_DBRKS_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD["pushdown"]["sourceQuery"] = (

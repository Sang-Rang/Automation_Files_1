...
PD_MSSQL_SCHEMA_SALES_DATASET = "AUTO_PD_MSSQL_SCHEMA_SALES"
...
PD_MSSQL_SCHEMA_SALES_PAYLOAD = {
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from dbo.sales where trdate = '${rd}'",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
...
PD_MSSQL_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD = copy.deepcopy(PD_MSSQL_SCHEMA_SALES_PAYLOAD)
PD_MSSQL_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD["pushdown"]["sourceQuery"] = (
    "select name, trdate from dbo.sales where trdate = '${rd}'"
)

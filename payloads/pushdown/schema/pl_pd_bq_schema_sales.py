...
PD_BQ_SCHEMA_SALES_DATASET = "AUTO_PD_BQ_SCHEMA_SALES"
...
PD_BQ_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD = copy.deepcopy(PD_BQ_SCHEMA_SALES_PAYLOAD)
PD_BQ_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD["pushdown"]["sourceQuery"] = (

...
PD_ATHENA_SCHEMA_SALES_DATASET = "AUTO_PD_ATHENA_SCHEMA_SALES"
...
PD_ATHENA_SCHEMA_SALES_PAYLOAD = {
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from default.sales where trdate = try_cast('${rd}' as DATE)",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
...
PD_ATHENA_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD = copy.deepcopy(PD_ATHENA_SCHEMA_SALES_PAYLOAD)
PD_ATHENA_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD["pushdown"]["sourceQuery"] = (
    "select name, trdate from default.sales where trdate = try_cast('${rd}' as DATE)"
)

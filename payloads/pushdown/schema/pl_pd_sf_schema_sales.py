...
PD_SF_SCHEMA_SALES_DATASET = "AUTO_PD_SF_SCHEMA_SALES"

PD_SF_SCHEMA_SALES_PAYLOAD = {
    "dataset": PD_SF_SCHEMA_SALES_DATASET,
    "runId": "2022-05-04",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from PUBLIC.SALES where \"TRDATE\" = '${rd}'",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
...
PD_SF_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD = copy.deepcopy(PD_SF_SCHEMA_SALES_PAYLOAD)
PD_SF_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD["pushdown"]["sourceQuery"] = (
    "select NAME, TRDATE from PUBLIC.SALES where \"TRDATE\" = '${rd}'"
)

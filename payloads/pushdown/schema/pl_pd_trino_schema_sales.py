...
PD_TRINO_SCHEMA_SALES_DATASET = "AUTO_PD_TRINO_SCHEMA_SALES"
...
PD_TRINO_SCHEMA_SALES_PAYLOAD = {
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from public.sales where trdate = TIMESTAMP '${rd}'",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
...
PD_TRINO_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD = copy.deepcopy(PD_TRINO_SCHEMA_SALES_PAYLOAD)
PD_TRINO_SCHEMA_SALES_REMOVED_COLUMN_PAYLOAD["pushdown"]["sourceQuery"] = (
    "select name, trdate from public.sales where trdate = TIMESTAMP '${rd}'"
)

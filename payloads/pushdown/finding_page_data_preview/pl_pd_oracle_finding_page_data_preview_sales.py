...
PD_ORACLE_DATASET_DATA_PREVIEW_SALES_PROFILE_DATASET = (
    "AUTO_PD_ORACLE_DATASET_DATA_PREVIEW_SALES_PROFILE"
)

PD_ORACLE_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE_PAYLOAD = {
    "dataset": PD_ORACLE_DATASET_DATA_PREVIEW_SALES_PROFILE_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runDateAdjustment": "",
    "runState": "DRAFT",
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from OWLUSER.SALES",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,

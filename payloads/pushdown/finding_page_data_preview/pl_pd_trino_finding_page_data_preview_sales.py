...
PD_TRINO_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE_DATASET = (
    "AUTO_PD_TRINO_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE"
)

PD_TRINO_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE_PAYLOAD = {
    "dataset": PD_TRINO_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,

...
PD_BQ_DATASET_DATA_PREVIEW_SALES_PROFILE_DATASET = "AUTO_PD_BQ_DATASET_DATA_PREVIEW_SALES_PROFILE"

PD_BQ_FINDING_PAGE_DATA_PREVIEW_SALES_PROFILE_PAYLOAD = {
    "runId": PROD_RUN_ID,
    "dataset": PD_BQ_DATASET_DATA_PREVIEW_SALES_PROFILE_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1

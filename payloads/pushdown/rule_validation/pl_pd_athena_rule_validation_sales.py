...
PD_ATHENA_RULE_VALIDATION_SALES_DATASET = "AUTO_PD_ATHENA_RULE_VALIDATION_SALES"
PD_ATHENA_RULE_VALIDATION_SALES_SECONDARY_DATASET_DATASET = (
    "AUTO_PD_ATHENA_RULE_VALIDATION_SALES_SECONDARY_DATASET"
)
...
PD_ATHENA_RULE_VALIDATION_SALES_SECONDARY_DATASET_PAYLOAD = {
    "runId": PROD_RUN_ID,
    "dataset": PD_ATHENA_RULE_VALIDATION_SALES_SECONDARY_DATASET_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1

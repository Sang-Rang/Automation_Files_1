...
PD_DBRKS_DQ_JOB_ROW_LIMIT_SALES_DATASET = "AUTO_PD_DBRKS_DQ_JOB_ROW_LIMIT_SALES"
PD_DBRKS_DQ_JOB_ROW_LIMIT_SALES_ROW_LIMIT = 5

PD_DBRKS_DQ_JOB_ROW_LIMIT_SALES_PAYLOAD = {
    "dataset": PD_DBRKS_DQ_JOB_ROW_LIMIT_SALES_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        ...
        "sourceQuery": f"select * from public.sales "
                       f"limit {PD_DBRKS_DQ_JOB_ROW_LIMIT_SALES_ROW_LIMIT}",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,

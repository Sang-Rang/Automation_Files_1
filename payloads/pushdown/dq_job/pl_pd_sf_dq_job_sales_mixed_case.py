...
PD_SF_DQ_JOB_SALES_MIXED_CASE_DATASET = "AUTO_PD_SF_DQ_JOB_Sales_Mixed_Case"

PD_SF_DQ_JOB_SALES_MIXED_CASE_PAYLOAD = {
    "runId": PROD_RUN_ID,
    "dataset": PD_SF_DQ_JOB_SALES_MIXED_CASE_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1
    },
    "host": "10.64.2.3:5432/rc202401?currentSchema=validation",
    "hootOnly": False,
    "logLevel": "INFO",
    "outliers": [],
    "patterns": [],
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "SELECT \"Name\", \"TRDate\", \"Sales\" from PUBLIC.\"SalesMixedCase\"",
        "backRuns": 0,
        "backRunBin": "DAY",

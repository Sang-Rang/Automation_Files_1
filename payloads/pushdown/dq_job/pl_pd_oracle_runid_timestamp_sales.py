PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_DATASET = "AUTO_PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES"
PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_RUNID = "2022-05-02 06:14:00"
PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_RUNID_END = "2022-05-04 12:34:00"

PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_PAYLOAD = {
  "dataset": PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_DATASET,
  "runId": PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_RUNID,
  "runIdEnd": PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_RUNID_END,
  "runDateAdjustment": "",
  "runState": "DRAFT",
  "passFail": 1,
  "passFailLimit": 75,
  ...
  "pushdown": {
    "dataset": PD_ORACLE_DQ_JOB_RUNID_TIMESTAMP_SALES_DATASET,
    "connectionName": "APPROVED_ORACLE_PUSHDOWN",
    "maxConnections": 10,
    "sourceQuery": "select * from OWLUSER.SALES where \"TRDATE\" >= TO_DATE('${rd}', 'YYYY-MM-DD') AND \"TRDATE\" < TO_DATE('${rdEnd}', 'YYYY-MM-DD') ",
    "backRuns": 0,
    "backRunBin": "DAY",
    "dateFormatType": "DATE",
    "threads": 2,

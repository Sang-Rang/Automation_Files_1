...
PD_ATHENA_DQ_JOB_ROW_LIMIT_SALES_DATASET = "AUTO_PD_ATHENA_DQ_JOB_ROW_LIMIT_SALES"
PD_ATHENA_DQ_JOB_ROW_LIMIT_SALES_ROW_LIMIT = 5

PD_ATHENA_DQ_JOB_ROW_LIMIT_SALES_PAYLOAD = {
    "dataset": PD_ATHENA_DQ_JOB_ROW_LIMIT_SALES_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": f"select * from default.sales "
                       f"limit {PD_ATHENA_DQ_JOB_ROW_LIMIT_SALES_ROW_LIMIT}",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,

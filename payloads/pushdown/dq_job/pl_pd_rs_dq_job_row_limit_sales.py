...
PD_RS_DQ_JOB_ROW_LIMIT_SALES_DATASET = "AUTO_PD_RS_DQ_JOB_ROW_LIMIT_SALES"
PD_RS_DQ_JOB_ROW_LIMIT_SALES_ROW_LIMIT = 5

PD_RS_DQ_JOB_ROW_LIMIT_SALES_PAYLOAD = {
    "dataset": PD_RS_DQ_JOB_ROW_LIMIT_SALES_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": f"select * from public.sales2 "
                       f"limit {PD_RS_DQ_JOB_ROW_LIMIT_SALES_ROW_LIMIT}",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,

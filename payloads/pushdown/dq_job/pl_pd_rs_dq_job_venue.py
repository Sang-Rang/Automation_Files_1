...
PD_RS_DQ_JOB_VENUE_DATASET = "AUTO_PD_RS_DQ_JOB_VENUE"

PD_RS_DQ_JOB_VENUE_PAYLOAD = {
    "runId": PROD_RUN_ID,
    "dataset": PD_RS_DQ_JOB_VENUE_DATASET,
    "colMatch": {},
    "transforms": [],
    "jobId": {
        "id": -1
    },
    "host": "10.64.2.3:5432/rc202403?currentSchema=validation",
    "hootOnly": False,
    "logLevel": "INFO",
    "outliers": [],
    "patterns": [],
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from public.venue",
        "backRuns": 0,
        "backRunBin": "DAY",

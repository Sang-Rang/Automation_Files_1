...
PD_ORACLE_DQ_JOB_ROW_LIMIT_SALES_DATASET = "AUTO_PD_ORACLE_DQ_JOB_ROW_LIMIT_SALES"
PD_ORACLE_DQ_JOB_ROW_LIMIT_SALES_ROW_LIMIT = 5

PD_ORACLE_DQ_JOB_ROW_LIMIT_SALES_PAYLOAD = {
  "dataset": PD_ORACLE_DQ_JOB_ROW_LIMIT_SALES_DATASET,
  "runId": PROD_RUN_ID,
  "runIdEnd": "",
  "runDateAdjustment": "",
  "runState": "DRAFT",
  ...
  "pushdown": {
    ...
    "maxConnections": 10,
    "sourceQuery": "select * from OWLUSER.SALES WHERE ROWNUM <= 5",
    "backRuns": 0,
    "backRunBin": "DAY",
    "dateFormatType": "DATE",
    "threads": 2,

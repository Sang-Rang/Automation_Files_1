PD_TRINO_RECORDS_NYSE_DATASET = "AUTO_PD_TRINO_RECORDS_NYSE"

PD_TRINO_RECORDS_NYSE_PAYLOAD = {
    "dataset": PD_TRINO_RECORDS_NYSE_DATASET,
    "runId": "2018-01-12",
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from public.nyse where trade_date = TIMESTAMP '${rd}'",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 1952,
                "dataset": "temDataset_79029aab66594803a99f55518fac614f",
                "only": False,
                "lookback": 5,
                "key": [
                    "symbol"

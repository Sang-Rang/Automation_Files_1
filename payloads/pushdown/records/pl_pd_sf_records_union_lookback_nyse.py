PD_SF_RECORDS_NYSE_UNION_LOOKBACK_DATASET = "AUTO_PD_SF_RECORDS_UNION_LOOKBACK_NYSE"

PD_SF_RECORDS_NYSE_UNION_LOOKBACK_PAYLOAD = {
    "dataset": PD_SF_RECORDS_NYSE_UNION_LOOKBACK_DATASET,
    "runId": "2017-12-19",
    "runIdEnd": "",
    "runDateAdjustment": "",
    "runState": "DRAFT",
    ...
    "outlierConfiguration": {
        ...
        "configurations": [
            {
                "id": 2511,
                "dataset": "temDataset_b50aa00706d34d2980eb6fa4c76e8279",
                "only": False,
                "lookback": 5,
                "lookbackQuery": "",
                "key": [

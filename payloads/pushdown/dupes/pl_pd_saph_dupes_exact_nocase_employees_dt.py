...
PD_SAPH_DUPES_EXACT_NOCASE_EMPLOYEES_DT_DATASET = "AUTO_PD_SAPH_DUPES_EXACT_NOCASE_EMPLOYEES_DT"

PD_SAPH_DUPES_EXACT_NOCASE_EMPLOYEES_DT_PAYLOAD = {
    "dataset": PD_SAPH_DUPES_EXACT_NOCASE_EMPLOYEES_DT_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
    ...
    "pushdown": {
        ...
        "maxConnections": 10,
        "sourceQuery": "select * from TEST.EMPLOYEES_DT",
        "backRuns": 0,
        "backRunBin": "DAY",
        "dateFormatType": "DATE",
        "threads": 2,

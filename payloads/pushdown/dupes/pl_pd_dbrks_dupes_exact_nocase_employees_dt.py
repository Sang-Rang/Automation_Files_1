...
PD_DBRKS_DUPES_EXACT_NOCASE_EMPLOYEES_DT_DATASET = "AUTO_PD_DBRKS_DUPES_EXACT_NOCASE_EMPLOYEES_DT"

PD_DBRKS_DUPES_EXACT_NOCASE_EMPLOYEES_DT_PAYLOAD = {
    "dataset": PD_DBRKS_DUPES_EXACT_NOCASE_EMPLOYEES_DT_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,

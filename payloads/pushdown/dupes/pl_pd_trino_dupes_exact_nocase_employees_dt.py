...
PD_TRINO_DUPES_EXACT_NOCASE_EMPLOYEES_DT_DATASET = "AUTO_PD_TRINO_DUPES_EXACT_NOCASE_EMPLOYEES_DT"

PD_TRINO_DUPES_EXACT_NOCASE_EMPLOYEES_DT_PAYLOAD = {
    "dataset": PD_TRINO_DUPES_EXACT_NOCASE_EMPLOYEES_DT_DATASET,
    "runId": PROD_RUN_ID,
    "runIdEnd": "",
    "runState": "DRAFT",
    "passFail": 1,
